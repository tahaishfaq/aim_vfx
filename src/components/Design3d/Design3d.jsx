      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <div className="flex flex-col items-center justify-center gap-y-4">
          <span className="flex items-center ">
            ...
            <h3 className="lg:text-[50px] text-3xl uppercase font-tek font-[300]  tracking-tight text-[#56BEC2]">
              creative-as-a-service
            </h3>
          </span>
          <Button className="px-8 lg:py-2.5 py-2 text-sm font-semibold border-2 border-[#fff] text-gray-200 bg-cyan-500 rounded-full hover:text-white hover:bg-cyan-600 focus:outline-none focus:border-gray-700 focus:shadow-outline-gray active:bg-gray-700 transition duration-150 ease-in-out uppercase">
            SEE ALL
          </Button>
        </div>

        <div className="mt-6 grid lg:grid-cols-2 grid-cols-1 gap-x-4 gap-y-10 sm:gap-x-6 md:grid-cols-3 md:gap-y-0 lg:gap-x-8">

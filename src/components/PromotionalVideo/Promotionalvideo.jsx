...
const Promotionalvideo = () => {
  return (
    <div className="">
      <div className="mx-auto px-4 py-16 sm:py-24 max-w-7xl lg:px-8">
        <div className="flex items-center flex-wrap justify-between">
          <h3 className="lg:text-8xl font-tek text-5xl uppercase font-normal max-w-xl  tracking-tight text-[#ffffff]">
            our promotional video portfolio
          </h3>
          <Button className="px-8 py-2.5 text-nowrap text-sm font-semibold border-2 border-[#fff] text-gray-200 bg-cyan-500 rounded-full hover:text-white hover:bg-cyan-600 focus:outline-none focus:border-gray-700 focus:shadow-outline-gray active:bg-gray-700 transition duration-150 ease-in-out uppercase">
            GO TO BLOG
          </Button>
        </div>

        <div className="mt-6 grid  gap-x-4 gap-y-10 sm:gap-x-6 md:grid-cols-3 md:gap-y-0 lg:gap-x-8">
